            ...
            <Modal.Body>
                <Form>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="date" value={transaction?.date} disabled={singleDate} onChange={e => setTransaction({ ...transaction, date: e.target.value })}></Form.Control>
                    </Form.Group>
                    <Form.Group>
                    ...
                    <Form.Group>
                        ...
                        <Form.Select disabled={!isAdd || singleType} value={transaction.type} onChange={e => {
