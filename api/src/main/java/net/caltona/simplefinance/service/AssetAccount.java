...
public class AssetAccount implements Account {
    ...
    public AssetAccount(String id, String name, Supplier<Map<String, Object>> configByNameSupplier, Supplier<List<Transaction>> transactionsSupplier) {
        this(id, name, transactionsSupplier);
    }

    @Override
    public TotalType totalType() {
        return TotalType.PHYSICAL_ASSET;
    }
